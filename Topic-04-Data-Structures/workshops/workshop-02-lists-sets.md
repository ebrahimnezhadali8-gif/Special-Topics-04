...
2. **Create and modify sets** using basic operations
...
3. [Exercise 2: Set Operations](#exercise-2-set-operations)
4. [Exercise 3: List and Set Problems](#exercise-3-list-and-set-problems)
...
## 🏃 Exercise 3: List and Set Problems
